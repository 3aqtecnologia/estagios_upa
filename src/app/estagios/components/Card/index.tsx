        ...
        <div className="flex flex-row items-center align-middle">
          ...
          <div className="justify-center px-3 py-4 ">
            <div className="flex flex-row justify-start ">
              <small className="px-4 py-1 text-xs font-semibold text-white uppercase align-middle bg-blue-500 rounded-full font-type-estagio" style={{ fontSize: 12 }}>OBRIGATÓRIO</small>
            </div>
            ...
            <p className="flex justify-start mt-2 text-sm font-semibold tracking-wide text-gray-800 align-middle">
