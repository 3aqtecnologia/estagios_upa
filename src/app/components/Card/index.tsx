    ...
    <>
      <div className="max-w-xs mx-1 my-2 overflow-hidden shadow-lg rounded-3xl">
        ...
        <div className="flex justify-center px-6 pt-4 pb-2 align-middle">
          <Link target='_top' href='https://institucional.universidadepatativa.com.br/estagios/' className="px-8 py-2 mb-2 font-light tracking-wide text-white bg-green-700 rounded-full hover:bg-green-900">
            Ver detelhes
          </Link>
